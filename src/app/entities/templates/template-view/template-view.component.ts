...
@Component({
  ...
  styleUrls: ['../../dialog-view-shared.scss', './template-view.component.scss']
})
export class TemplateViewComponent implements OnInit {
  ...
  constructor(protected requestService: RequestService, private matDialog: MatDialog,
    ...
    public dialogRef: MatDialogRef<TemplateViewComponent>, protected persistencyService: PersistencyService) 
  {
